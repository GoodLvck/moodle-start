...
class __Mustache_848d2ae5ffa7cf2a6e88b9ea8c38420d extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->sectionC1b129fd4942d220ea10cb2d32e081d8($context, $indent, $value);
...
';
        ...
        if (empty($value)) {
            ...
            $buffer .= $this->sectionF40e92dfaacb6fe8e9b041e1f3ed296a($context, $indent, $value);
        }
...
';
    ...
    private function sectionC1b129fd4942d220ea10cb2d32e081d8(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
    ...
    private function sectionF40e92dfaacb6fe8e9b041e1f3ed296a(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
    
        if (!is_string($value) && is_callable($value)) {
            $source = '
require([\'theme_snap/accessibility\'], function(module) {
    module.enhanceform({{#quote}}{{element.id}}{{/quote}});
});
';
            $result = call_user_func($value, $source, $this->lambdaHelper);
            if (strpos($result, '{{') === false) {
            ...
            foreach ($values as $value) {
                ...
                $buffer .= $indent . 'require([\'theme_snap/accessibility\'], function(module) {
';
                $buffer .= $indent . '    module.enhanceform(';
                // 'quote' section
