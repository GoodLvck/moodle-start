...
class __Mustache_9322380bfa2dcff0c92d03f5ffe54d23 extends Mustache_Template
{
...
';
        ...
        $buffer .= '
';
        $buffer .= $indent . '<span class="form-control-feedback invalid-feedback" id="id_error_';
        $value = $this->resolveValue($context->findDot('element.name'), $context);
        $buffer .= call_user_func($this->mustache->getEscape(), $value);
        $buffer .= '" ';
        // 'error' section
