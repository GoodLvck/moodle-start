...
class __Mustache_a29409a0d298f1de9d221b3a691b8ca0 extends Mustache_Template
{
...
';
        $buffer .= $indent . '    <div>
';
        $buffer .= $indent . '        <span class="float-md-right text-nowrap">
';
        $buffer .= $indent . '            ';
        // 'required' section
...
';
        ...
        $buffer .= $indent . '    </div>
';
        $buffer .= $indent . '    <div class="form-inline felement" data-fieldtype="';
