...
class __Mustache_33448f1196760481e6fd1395e82cd871 extends Mustache_Template
{
...
';
        $buffer .= $indent . '                    <a id="addbtn" title="';
        // 'str' section
        $value = $context->find('str');
...
';
        $buffer .= $indent . '                    <button id="createfolderbtn" title="';
        // 'str' section
        $value = $context->find('str');
...
';
        $buffer .= $indent . '                    <button id="downloadfolderbtn" title="';
        // 'str' section
        $value = $context->find('str');
...
';
        $buffer .= $indent . '                    <button id="deletebtn" role="button" title="';
        // 'str' section
        $value = $context->find('str');
...
';
        $buffer .= $indent . '                <button id="displayiconsbtn" title="';
        // 'str' section
        $value = $context->find('str');
...
';
        $buffer .= $indent . '                </button>
';
        $buffer .= $indent . '                <button id="displaydetailsbtn" title="';
        // 'str' section
        $value = $context->find('str');
...
';
        $buffer .= $indent . '                </button>
';
        $buffer .= $indent . '                <button id="displaytreebtn" title="';
        // 'str' section
        $value = $context->find('str');
