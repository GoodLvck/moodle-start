...
class __Mustache_3f8ad5e6c9da18bf794393060d259d6d extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->section73434ffc7a2c87c9a60cd4601265a53d($context, $indent, $value);
        $buffer .= $indent . '
';
        $buffer .= $indent . '
';
        ...
        if (empty($value)) {
            ...
            $buffer .= $indent . '    <div id="snap-pm-courses-current" class="tab-pane clearfix active" role="tabpanel" aria-label="snap-pm-tab-current" tabindex="0">
';
            $buffer .= $indent . '        <h2>';
            // 'str' section
...
';
    ...
    private function section73434ffc7a2c87c9a60cd4601265a53d(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
            ...
            foreach ($values as $value) {
                ...
                $buffer .= $indent . '    <div id="snap-pm-courses-current" class="tab-pane active" role="tabpanel" aria-label="snap-pm-tab-current">
';
                // 'published' section
