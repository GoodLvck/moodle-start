...
class __Mustache_7f1c765319161ae8631b20a02a85855c extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $indent . '<div class="form-item" id="';
...
';
        ...
        $buffer .= $indent . '        </label>
';
        $buffer .= $indent . '        <span class="form-shortname small text-muted">';
